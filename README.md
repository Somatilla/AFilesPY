# AFilesPY
im making a python file manger! (one of my smaller projects)

# How to use:
download it and put it somewhere in your files (i recommend the C: drive for full file access)
  <h3>Commands:</h3>
    ls |directory|-optional --lists directory <br>
